...
const supabaseService = {
  ...
  async createPsychologist(psychologistData) {
    ...
    const dataToInsert = {
      ...
      documento: psychologistData.documento || '',
      email: psychologistData.email || '',
      telefono: psychologistData.telefono || '',
      genero: psychologistData.genero || '',
      fecha_nacimiento: psychologistData.fecha_nacimiento || null,
      direccion: psychologistData.direccion || '',
      especialidad: psychologistData.especialidad || '',
      licencia: psychologistData.licencia || '',
      notas: psychologistData.notas || '',
      created_at: new Date().toISOString(),
      updated_at: new Date().toISOString()
    };
  ...
  async createPatient(patientData) {
    // Asegurar que los campos coincidan con la estructura de la tabla
    const dataToInsert = {
      usuario_id: patientData.usuario_id || null,
